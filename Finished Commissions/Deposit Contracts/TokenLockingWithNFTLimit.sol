...
//////////////////////                                                              /////////////////////////////
    ...
    function EditNFT(ERC721 WhatNFT) public {
    ...
    function deposit(uint amount) public {
        ...
        require(NFT.balanceOf(msg.sender) >= 1, "You do not have the right NFT in order to use this contract");
...
//////////////////////                                                              /////////////////////////////
    ...
    function CalculateTime(address YourAddress) public view returns (uint256){
