...
//// This contract simply enables a staking system with a locking and timelock withdraw feature.
...
//// Commissioned by Christian_#1203 on 5/29/2022
...
//// All the Variables that this contract uses (basically the dictionary for this contract)
    ...
    uint public TimeLockTime;                           // How long the withdraw timelock is.
...
//////////////////////                                                              /////////////////////////////
    ...
    function EditTimeLockTime(uint HowManyBlocks) public {
