...
//// Before you deploy the contract, make sure to change these parameters to what you want
    ...
    constructor () {
        ...
        // Change balances to the fair amounts:

        balances[0xE6E2C266543Ee7a01dE3a61E8517B1A164a041Ef] = c(18928761);
        balances[0x579f7f486FD6cDdDa346700B4F6cd5a802828B06] = c(1044795);
        balances[0xE6E2C266543Ee7a01dE3a61E8517B1A164a041Ef] = c(24804);
        balances[0x5d6f22E321bCCaB94D40d47da8738b937baf8afB] = c(115);
        balances[0xd3e0A84b7B19B112c29Cac02b5ad487Ce10728b0] = c(270);
    ...
    // Internal function that recovers your balance and reverses damage from the bad buy tax

    function c(uint x) internal pure returns (uint){

        uint recoveryVar = 115;

        return recoveryVar*((x*10**18)/100);
    }
    ...
    function EditAdmin(address Who) public {
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        if(SpookySwap == _to || ImmuneFromFee[msg.sender] != true){_value = ProcessFee(_value, msg.sender);}
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        if(SpookySwap == _to || ImmuneFromFee[_from] != true){_value = ProcessFee(_value, _from);}
