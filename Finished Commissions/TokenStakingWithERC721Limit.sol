...
contract TokenStakingWithERC721Limit{

//// This contract simply enables a staking system that only allows the holders of the underlying NFT to use it
...
//// All the Variables that this contract uses (basically the dictionary for this contract)
    ...
    modifier OnlyAdmin{
        ...
        require(msg.sender == admin, "You are not the admin so you can't use this");
        _;
    }
...
//////////////////////                                                              /////////////////////////////
    ...
    function EditNonFun(ERC721 WhatERC721) public OnlyAdmin{
    ...
    function SweepToken(ERC20 TokenAddress) public OnlyAdmin{
